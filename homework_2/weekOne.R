...
print(male)
alco_fem <- length(as.array(which(as.array(df$alco == 1) & female)))
print(alco_fem)
alco_m <- length(as.array(which(as.array(df$alco == 1) & male)))
print(length(female))
print(alco_fem)
print(alco_m)
smoke_fem <- length(as.array(which(as.array(df$smoke == 1) & female)))
smoke_m <- length(as.array(which(as.array(df$smoke == 1) & male)))
s_f <- smoke_fem / length(female) * 100
